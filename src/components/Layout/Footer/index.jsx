        ...
        <div className="grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
          <div className='col-span-6'>
            <img
              ...
              alt="Crypto-Logo"
            />
            <h3 className='text-white/60 text-sm font-normal leading-9 mb-4 lg:mb-16'> COD is a type of virtual lorem that uses lorem to secure transactions that are digitally lorem on a distributed ledger, such as a lorem.</h3>
